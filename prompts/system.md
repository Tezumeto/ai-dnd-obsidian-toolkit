...
| Создание существа | `creature_creation.md` | Пользователь просит создать монстра, зверя, тварь |
...
| Дизайн загадок | `puzzle_design.md` | Создание головоломок, испытаний, механических комнат |
