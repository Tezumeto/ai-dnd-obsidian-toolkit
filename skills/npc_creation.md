...
1. **Локация** — если NPC привязан к городу/региону:
   - Файл города: `0.Лор/Мир/Атлас/**/*.md`
   - Файл организации/государства: `0.Лор/Мир/Организации/**/*.md`

2. **Организация** — если NPC член организации:
   - `0.Лор/Мир/Организации/**/*.md`

3. **Раса** — если NPC не человек:
   - `0.Лор/Мир/Расы/**/*.md`

### Опционально:
- Связанные события: `0.Лор/Мир/Хронология/**/*.md` (для исторического контекста)
...
**Эталон:** `1.Черновик/Мэрта Хальг.md` — пример идеально оформленного NPC
...
- `0.Лор/НПЦ/Common/` — для **обычных NPC** (CR 0-4):
...
- `0.Лор/НПЦ/Uncommon/` — для **необычных NPC** (CR 5-10):
...
- `0.Лор/НПЦ/Legendary/` — для **легендарных NPC** (CR 11+):
...
**Автор skill:** claude
**Эталон:** `1.Черновик/Мэрта Хальг.md`
