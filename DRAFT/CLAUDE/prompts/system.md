...
│
├── zUtilities/
│   ├── 901_Templates/         — шаблоны Obsidian (опционально)
...
# Найти по типу
grep "type: город" !Лор/Мир/103_Атлас/ -r --files-with-matches
...
glob "!Лор/Мир/103_Атлас/**/*Сейра*.md"
...
grep "date: 18[0-9][0-9]" !Лор/Мир/102_События/ -r
```

**Принцип:** Всегда уточняй подпапку (103_Атлас, 106_Государства) вместо поиска по всему `!Лор/`.
